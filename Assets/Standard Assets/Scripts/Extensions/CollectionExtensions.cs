...
namespace Extensions
{
	public static class CollectionExtensions 
	{
		...
		public static T1 GetKey<T1, T2> (this SortedDictionary<T1, T2> dict, int index)
		{
			if (index < 0)
				throw new IndexOutOfRangeException("GetKey<T1, T2> (this SortedDictionary<T1, T2> dict, int index) was given an index below 0");
			IEnumerator keyEnumerator = dict.Keys.GetEnumerator();
			while (keyEnumerator.MoveNext())
			{
				index --;
			...
			throw new IndexOutOfRangeException("GetKey<T1, T2> (this SortedDictionary<T1, T2> dict, int index) was given an index >= dict.Count");
		}
