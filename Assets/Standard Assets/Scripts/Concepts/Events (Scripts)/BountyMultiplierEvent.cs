...
namespace BMH
{
	public class BountyMultiplierEvent : Event
	{
		...
		public override void ApplyEffect (Player player)
		{
			...
			{
				if (GameManager.GetSingleton<Player>() == player)
			...
			else if (GameManager.GetSingleton<Player>() == player)
				GameManager.GetSingleton<Battle>().scoreChangeMultiplier *= bountyMultiplier;
		}
