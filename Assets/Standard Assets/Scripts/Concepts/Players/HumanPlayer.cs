...
namespace BMH
{
	public class HumanPlayer : Player, ISavableAndLoadable
	{
		...
		public override void DoUpdate ()
		{
			...
			body.DoUpdate ();
			weapon.DoUpdate ();
			if (InputManager.inputters[GameManager.GetSingleton<GameManager>().teams.IndexOf_class(owner)].GetButtonDown("Switch Positions") && CanSwitchPositions)
				Switch ();
		}

		public new static HumanPlayer GetInstance ()
		{
			if (instance == null)
