...
namespace BMH.Analytics
{
	public class AnalyticsManager : SingletonMonoBehaviour<AnalyticsManager>
	{
		...
		public bool CollectAnalytics
		{
			get
			{
				return SaveAndLoadManager.GetValue<bool>("Collect Analytics", collectAnalyticsDefault);
			}
			set
			{
				SaveAndLoadManager.SetValue("Collect Analytics", value);
			}
		}
		public bool LogAnalyticsLocally
		{
			get
			{
				return SaveAndLoadManager.GetValue<bool>("Log Analytics Locally", logAnalyticsLocallyDefault);
			}
			set
			{
				SaveAndLoadManager.SetValue("Log Analytics Locally", value);
			}
		}
		public int SessionNumber
		{
			get
			{
				return SaveAndLoadManager.GetValue<int>("Session Number", 0);
			}
			set
			{
